...
```
Время инференса на изображении 128х128 -> 256х256 используя GPU RTX 5060 в среднем составляет 0.007 секунды (7 миллисекунд)
...
Если нужно немного качественнее результат увеличьте --dim 256, скорость инференса увиличется промерно до
